        ...
        <v-col class="d-flex justify-center align-center">
            <v-expansion-panels variant="accordion">
                ...
                <v-expansion-panel title="Jakie aplikacje tworzymy?"
                                   text="Jesteśmy w stanie stoworzyć szeroki zakres aplikacji od aplikacji desktopowych po webowe oraz mobilne. Chcesz dowiedzieć się czy wykonamy dla Ciebie Twoją wymarzoną aplikację? Napisz do nas"></v-expansion-panel>
                <v-expansion-panel title="Jak się kontaktować?"
                                   text="Preferowaną przez nas formą pierwszego kontaktu jest e-mail. Dostępne dane znajdziesz na stronie 'Kontakt'"></v-expansion-panel>
            </v-expansion-panels>
        </v-col>
    </v-container>
</template>
